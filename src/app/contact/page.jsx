  ...
  return (
    <section id="contact" className="bg-[#0a0f1a] text-white py-16 px-6 md:px-12 flex flex-col md:flex-row gap-12 max-w-6xl mx-auto">
      ...
      <div className="flex-1 flex flex-col gap-6 text-white">
        ...
        <div className="flex items-center gap-3"><FaEnvelope className="text-teal-400 text-xl" /><span>ma8966534@gmail.com</span></div>
        <div className="flex items-center gap-3"><FaPhone className="text-teal-400 text-xl" /><span>+20 01001514586</span></div>
