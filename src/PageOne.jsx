      ...
      <div className="fimo">
        <div className="card1">
          <div className="image_container">
            <video controls poster="/viduo/Image.jpg" id="player1" style={{ width: '100%' }}>
        ...
        <div className="card1">
          <div className="image_container">
            <video controls poster="/viduo/Image.jpg" id="player2" style={{ width: '100%' }}>
        ...
        <div className="card1">
          <div className="image_container">
            <video controls poster="/viduo/Image.jpg" id="player3" style={{ width: '100%' }}>
